        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DetectedBudget = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    DetectedUsageNeed = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChatbotLogs_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cpu = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: true),
                    Ram = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: true),
                    Ssd = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: true),
                    Gpu = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: true),
                    Screen = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: true),
                    Battery = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: true),
                    Weight = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: true),
                    OperatingSystem = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: true),
                    StockQuantity = table.Column<int>(type: "int", nullable: false),
                    SoldQuantity = table.Column<int>(type: "int", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(2500)", maxLength: 2500, nullable: false),
                    SuitableNeeds = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Products_Sold_NonNegative", "[SoldQuantity] >= 0");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_OrderDetails_LineTotal_NonNegative", "[LineTotal] >= 0");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatbotLogs_ApplicationUserId",
                table: "ChatbotLogs",
                column: "ApplicationUserId");
